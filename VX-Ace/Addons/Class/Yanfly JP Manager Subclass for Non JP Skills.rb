#==============================================================================
#
# ▼ Yanfly Engine Ace - JP Manager v1.06 Addon for subclass - Non JP Skills
...
class Game_Actor < Game_Battler
  ...
  def subclass_add_exp(class_id,value)
    if @subclass_id != nil && @subclass_id != 0
      last_level = class_level(@subclass_id).to_i
      last_skills = skills
      r2_subclass_add_ecp_82v7b4(@subclass_id,value)
    else
      return if !@subclass_id
      return if @subclass_id == 0
